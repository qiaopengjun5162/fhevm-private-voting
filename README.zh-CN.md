...
前端部署在 Vercel: [fhevm-private-voting-nine.vercel.app](https://fhevm-private-voting-nine.vercel.app/)

> 合约部署在 Sepolia 测试网。连接 MetaMask (Sepolia)，粘贴合约地址，即可体验完整 FHE 投票流程。
